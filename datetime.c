...
/***************************************************************************
 * FUNCTION to calculate the current time and date
 * INPUT : (display time string, display date string, start second, start minute, start hour, start weekday, start day, start month, 
 *          start year, start season).
 * OUTPUT: 1. returns any subunit of current time as an integer and autumatically updates 
 *         the start time.
