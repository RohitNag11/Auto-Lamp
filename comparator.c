...
void Comp1_init(void)
{
    ...
    CM1CON0bits.HYS=1;      /*a little bit of hysteresis to stop multiple
                              triggers*/
    CM1CON0bits.POL=1;      //inverted comparator output
    CM1CON1bits.INTP=1; 	//set interrupt flag on rising edge
    CM1CON1bits.INTN=1; 	//set interrupt flag on falling edge
